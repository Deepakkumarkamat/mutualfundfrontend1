...
const routes: Routes = [
  ...
  {path:'investNow/allfundsdetail/:id/sip',component:SipComponent},
  {path:'investNow/allfundsdetail/:id/buying',component:BuyingComponent},
  ...
  {path: 'investNow/allfundsdetail/:id', component:AllfundsdetailComponent},
  ...
  {path:'update/:email',component:SendOtpComponent},
